...
public class CustomerDemandGoodsServiceImpl extends BaseService<CustomerDemandGoods> implements ICustomerDemandGoodsService {
    ...
    @Override
    public List<CustomerDemandGoods> listCustomerDemandGoodsByManyCondition(String createNoBen, String createNoEnd, String createDateBen, String createDateEnd, String customerNoBen, String customerNoEnd) {
        try {
