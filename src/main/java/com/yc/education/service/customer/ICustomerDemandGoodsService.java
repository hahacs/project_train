...
public interface ICustomerDemandGoodsService extends IService<CustomerDemandGoods>{
     ...
     * @return
     */
    List<CustomerDemandGoods> listCustomerDemandGoodsByManyCondition(String createNoBen,String createNoEnd,String createDateBen,String createDateEnd,String customerNoBen,String customerNoEnd);
