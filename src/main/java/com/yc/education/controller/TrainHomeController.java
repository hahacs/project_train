 ...
 */
@Controller
public class TrainHomeController extends BaseController implements Initializable {
    ...
    @FXML private VBox btn1,btn2,btn3,btn4,btn5,btn6,btn7,btn8,btn9;
...
//    private  String url="/fxml/sale_data.fxml"; //默认fxml
    ...
    public void removeClass(){
        ...
        btn9.getChildren().get(0).setStyle(" -fx-background-image: url('/images/basic/zl.png');");
        btn9.getChildren().get(1).setStyle(defaultFontColor);
    }
...
//            btn1.getChildren().get(1).setStyle(checkedFontColor);
            btn9.setStyle(checkedColor);
            btn9.getChildren().get(0).setStyle(" -fx-background-image: url('/images/basic/zled.png');");
