...
public class CustomerProperty {
     ...
     * 客户等级
     */
    private SimpleStringProperty customerLevel;
     ...
     * 一般客户
     */
    private SimpleBooleanProperty generalCustomer;


    public CustomerProperty() {
    }

    public CustomerProperty(Long id, String customerType, String customerLevel, String customerCode, String shortName, Date addtime, Boolean generalCustomer,String remark) {
        if(id != null){
