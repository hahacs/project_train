...
public class ProductPriceProperty {
    ...
    private  final SimpleLongProperty protype = new SimpleLongProperty();

    private  final SimpleLongProperty basicunit = new SimpleLongProperty();
     ...
     * @param remarks
     */
    public ProductPriceProperty(long id,String isnum,String proname,long protype,long basicunit,Double normprice,Double lowprice,String remarks ) {
        setId(id);
        setIsnum(isnum);
        setProname(proname);
        setProtype(protype);
    ...
    public SimpleLongProperty protypeProperty() {
        return protype;
    }
    ...
    public SimpleLongProperty basicunitProperty() {
        return basicunit;
    }
