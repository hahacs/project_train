...
public class SupplierPurchaser {
    ...
    public SupplierPurchaser(long id,String staffcode,  String staffname, String keycontent, String staffremarks) {
        this.id=id;
    ...
    public SupplierPurchaser(long id,Long staffid,String staffcode, String staffname, String keycontent, String staffremarks, Integer ispoint, Long supplierid) {
        this.id=id;
        this.staffcode = staffcode;
