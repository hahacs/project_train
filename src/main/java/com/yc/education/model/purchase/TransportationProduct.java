...
public class TransportationProduct {
    ...
    public TransportationProduct(Long parentid, String purchaseorder, Integer sort, String pronum, String stocknum, String boxnum, Integer thistimeontheway, Integer totalnum, Integer stockover, Integer forcenum, Integer ontheway) {
    ...
    public TransportationProduct(long id,Long parentid, String purchaseorder, Integer sort, String pronum, String stocknum, String boxnum, Integer thistimeontheway, Integer totalnum, Integer stockover, Integer forcenum, Integer ontheway) {
        this.id = id;
        this.parentid = parentid;
        this.purchaseorder = purchaseorder;
        this.sort = sort;
