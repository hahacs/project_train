...
public class PurchaseProduct {
    ...
    public PurchaseProduct(long id,String sourseorder, String orders, Integer sort, String proorders, String proname, String supname, Integer num, String unit, Double price, Double totalprice, String remarks, Long purchaseid) {
        this.id = id;
    ...
    public PurchaseProduct(String sourseorder, String orders, Integer sort, String proorders, String proname, String supname, Integer num, String unit, Double price, Double totalprice, String remarks, Long purchaseid) {
        this.sourseorder = sourseorder;
        this.orders = orders;
        this.sort = sort;
        this.proorders = proorders;
