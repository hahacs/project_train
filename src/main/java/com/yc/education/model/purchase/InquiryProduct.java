...
public class InquiryProduct {
    ...
    public InquiryProduct(String proisnum, String proname, String protype, Integer pronum, String prounit, Double proprice, Double totalprice, String proremark, Long inquiryid) {
    ...
    public InquiryProduct(long id,String proisnum, String proname, String protype, Integer pronum, String prounit, Double proprice, Double totalprice, String proremark, Long inquiryid) {
        this.id = id;
        this.proisnum = proisnum;
        this.proname = proname;
        this.protype = protype;
