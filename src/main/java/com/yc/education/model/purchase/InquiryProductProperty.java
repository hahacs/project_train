...
public class InquiryProductProperty {
    ...
    public InquiryProductProperty(long editId ,String proisnum,String proname,String protype,String pronum,String prounit,String proprice,String totalprice,String proremark) {
    setEditId(editId);
