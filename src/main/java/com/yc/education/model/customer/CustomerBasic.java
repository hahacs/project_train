...
public class CustomerBasic {
    ...
    private Integer initialQuotaMoneyType;
     ...
     */
    public Integer getInitialQuotaMoneyType() {
     ...
     */
    public void setInitialQuotaMoneyType(Integer initialQuotaMoneyType) {
