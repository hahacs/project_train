...
public class StockOutSaleProductProperty {
    ...
    public StockOutSaleProductProperty(long id, Long stockOutSaleId,String orderSource, String orderNo, String productNo, String productName, String category, Integer num, Long unit, BigDecimal price, String warehouseName, String floor, String remarks) {
        setId(id);
