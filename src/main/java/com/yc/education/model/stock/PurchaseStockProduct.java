...
public class PurchaseStockProduct {
    ...
    public PurchaseStockProduct(long id,String sourseorder, String orders, Integer sort, String seeorder, String pronum, String proname, Integer stocknum, String units, String depotnum, String depotname, String remarks, Long purchasestockid) {
        this.id = id;
    ...
    public PurchaseStockProduct(String sourseorder, String orders, Integer sort, String seeorder, String pronum, String proname, Integer stocknum, String units, String depotnum, String depotname, String remarks, Long purchasestockid) {
        this.sourseorder = sourseorder;
        this.orders = orders;
        this.sort = sort;
        this.seeorder = seeorder;
