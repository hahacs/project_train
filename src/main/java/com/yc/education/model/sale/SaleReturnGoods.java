...
public class SaleReturnGoods {
     ...
     * 仓库位置描述
     */
    @Column(name = "warehouse_location_str")
    private String warehouseLocationStr;
     ...
     * 获取仓库位置描述
     *
     * @return warehouse_location_str - 仓库位置描述
     */
    public String getWarehouseLocationStr() {
        return warehouseLocationStr;
    }

    /**
     * 设置仓库位置描述
     *
     * @param warehouseLocationStr 仓库位置描述
     */
    public void setWarehouseLocationStr(String warehouseLocationStr) {
        this.warehouseLocationStr = warehouseLocationStr;
    }
